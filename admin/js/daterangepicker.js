...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define(['NiceAdmin/js/moment', 'jquery'], function (moment, jquery) {
        ...
        if (!jQuery) {
            jQuery = require('NiceAdmin/js/jquery');
            if (!jQuery.fn) jQuery.fn = {};
        }
        var moment = (typeof window != 'undefined' && typeof window.moment != 'undefined') ? window.moment : require('NiceAdmin/js/moment');
