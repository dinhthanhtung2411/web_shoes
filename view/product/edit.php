    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <form role="form" method="post" enctype="multipart/form-data">
                ...
                <p>Product Type</p>
                <select class="form-control" id="productSelect" name="category_id"><option>Please Select Type</option>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="description" type="text" value="<?php echo $product->getDescription()?>">
                </div>
                <div>
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-success loginFormElement" onclick="return confirm('Bạn đẫ sua thành công ')">Edit Product</button>
