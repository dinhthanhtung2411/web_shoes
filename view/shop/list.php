                        ...
                        <div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
                            <div class="product d-flex flex-column">
                                ...
                                <div class="text py-3 pb-4 px-3">
                                    ...
                                    <h3><a href="index.php?page=shop&action=show&product-id=<?php echo $product->getId(); ?>"><?php echo $product->getName(); ?></a></h3>
                                    <div class="pricing">
                                        <p class="price"><span><?php echo $product->getPrice(); ?></span></p>
                                    </div>
                                    <p class="bottom-area d-flex px-3">
                                        <a href="index.php?page=shop&action=getList&add-cart=true&product-id=<?php echo $product->getId(); ?>" class="add-to-cart text-center py-2 mr-1"><span>Add to cart <i class="ion-ios-add ml-1"></i></span></a>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading" role="tab" id="headingOne">
                                        <h4 class="panel-title">
                                            <a href="index.php?page=shop&action=getList&filter=true&category=<?php echo $category->getId(); ?>"
                                               class="collapsed"><?php echo $category->getName(); ?>
                                            </a>
                                        </h4>
                                    </div>
                                </div>
