...
<section class="ftco-section">
    <div class="container">
        <div class="row">
            ...
            <form class="col-lg-6 product-details pl-md-5 ftco-animate" method="post">
                ...
                <p class="price"><span><?php echo $product->getPrice(); ?> VND</span></p>
	             	...
	             	<span class="input-group-btn mr-2">
	                   ...
	                   <i class="ion-ios-remove"></i>
                        ...
                        <input type="text" id="quantity" name="quantity" class="quantity form-control input-number"
                               value="<?php echo $_SESSION['cart']["$product->getId()"] ?>" min="1" max="100">
                ...
                <p><input type="submit" class="btn btn-black py-3 px-5 mr-2" value="Add to cart">
                    <a href="index.php?page=cart&action=getList" class="btn btn-primary py-3 px-5">Buy now</a></p>
            </form>
            </div>
        </div>
            ...
            <div class="col-md-12 tab-wrap">
                ...
                <div class="tab-content bg-light" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="day-1-tab">
                        <div class="p-4">
                            <h3 class="mb-4"><?php echo $product->getName()?></h3>
                            <p> <?php echo $product->getDescription()?></p>
                    </div>
